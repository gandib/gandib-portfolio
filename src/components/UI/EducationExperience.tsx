    ...
    <div className="my-16">
      ...
      <div className="grid md:grid-cols-11 gap-4">
        ...
        <motion.div
          ...
          className="md:col-span-5 flex flex-col items-end"
        >
      ...
      <div className="grid md:grid-cols-11 gap-4">
        ...
        <motion.div
          ...
          className="md:col-span-5 flex flex-col items-end mt-8 sm:mt-12"
        >
        ...
        <motion.div
          ...
          className="md:col-span-5 flex flex-col items-start sm:mt-12"
        >
